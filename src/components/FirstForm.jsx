...
const FirstForm = (props) => {
  const { nextStep, setName, setInterviewTime, err } = props;
  ...
  return (
    <div className="bg-[#071028] px-[4vw] py-[2vh] h-screen   ">
      ...
      >
        <img src={logo} alt="logo" className="h-[6vh] cursor-pointer " />
        <p className="text-white p-[1vh] cursor-pointer text-2xl font-bold">
          ReadyQ
        </p>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div className="w-[45vw] mt-[18vh]">
          ...
          <div className="w-[90%] mb-[6vh]">
            <p className="bg-gradient-to-r from-pink-800 to-[#2E2EF4] bg-clip-text text-transparent font-extrabold text-6xl ">
              Transform Interview Anxiety Into Confidence
            </p>
          </div>
          {/* text */}
          ...
          <div>
            <input
              ...
              className="text-white text-xl w-full outline-none border-none focus:outline-none focus:border-none bg-[#071028] mb-[1vh]"
            />
            <hr className="w-1/2" />
          </div>
          {/* buttons */}
